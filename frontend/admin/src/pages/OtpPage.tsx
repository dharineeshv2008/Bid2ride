...
export const OtpPage: React.FC = () => {
  ...
  const phone = location.state?.phone || '+919999999999';
  ...
  return (
    <div>
      <button
        ...
        className="inline-flex items-center gap-1 text-xs font-semibold text-sky-400 hover:text-sky-300 mb-4"
      >
      ...
      <p className="text-slate-400 text-sm mb-6">
        Sent to <span className="font-semibold text-slate-200">{phone}</span>.
      </p>
        ...
        <div className="flex items-center justify-between text-sm px-1">
          {timer > 0 ? (
            ...
            <button
              ...
              disabled={isSubmitting}
              className="inline-flex items-center gap-1.5 font-bold text-sky-400 hover:text-sky-300 transition-colors disabled:opacity-50"
            >
